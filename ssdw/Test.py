...
net.load_state_dict(torch.load('./weights/2.pth',map_location=lambda storage, loc: storage))
img_id = 60
image = cv2.imread('./2/100_3061.bmp', cv2.IMREAD_COLOR)
...
for i in range(detections.size(1)):
    j = 0
    print('zzzzzzzzzzzz',detections[0,i,j,0])
    while detections[0,i,j,0] >= 0.24:
